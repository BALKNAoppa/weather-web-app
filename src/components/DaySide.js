  ...
  return (
    <div class="w-[414px] h-[828px] flex flex-col items-center justify-center relative">
      <div class="w-[174px] h-[91px] absolute top-[56px] left-[40px]">
        ...
        <div class="text-[48px] font-extrabold leading-[65.57px]">
          {weather.cityname}
        </div>
      </div>
      <img
      ...
      <div class="w-[360px] h-[230px] absolute bottom-[128px] z-[999]">
        <div class="text-[120px] font-extrabold leading-[196.7px] bg-gradient-to-r from-[#111827] to-[#6b727f] bg-clip-text text-transparent">
          {weather.max_c}°
        </div>
