    ...
    <div class="font-manrope">
      <div class="w-full overflow-hidden h-screen bg-gray-100 flex items-center justify-center absolute">
        ...
        <div class="basis-1/2 h-screen bg-gray-100 flex items-center justify-center">
          <img
            class="h-[340px] absolute z-0 right-1/2"
            src="./img/eclipce.png"
            alt=""
          />
          <img
            class="h-[540px] absolute z-0 right-1/2"
            src="./img/eclipce.png"
            alt=""
          />
          <img
            class="h-[940px] absolute z-0 right-1/2"
            src="./img/eclipce.png"
            alt=""
          />
          <img
            class="h-[1340px] absolute z-0 right-1/2"
            src="./img/eclipce.png"
            alt=""
          />
          <img
            class="h-[1740px] absolute z-0 right-1/2"
            src="./img/eclipce.png"
            alt=""
          />
          ...
          <div class="w-[414px] h-[828px] rounded-[48px] z-0 absolute">
            <img
              class="w-[176px] h-[176px] absolute top-[-70px] left-[-70px]"
              src="./img/Group 2.png"
              alt=""
            />
          </div>
        ...
        <div class="h-screen bg-[#0F141E] basis-1/2 flex items-center justify-center">
          <img
            class="h-[340px] absolute z-0 left-1/2"
            src="./img/Ellipse 25.png"
            alt=""
          />
          <img
            class="h-[540px] absolute z-0 left-1/2"
            src="./img/Ellipse 25.png"
            alt=""
          />
          <img
            class="h-[940px] absolute z-0 left-1/2"
            src="./img/Ellipse 25.png"
            alt=""
          />
          <img
            class="h-[1340px] absolute z-0 left-1/2"
            src="./img/Ellipse 25.png"
            alt=""
          />
          <img
            class="h-[1740px] absolute z-0 left-1/2"
            src="./img/Ellipse 25.png"
            alt=""
          />
          ...
          <div class="w-[414px] h-[828px] rounded-[48px] z-0 absolute">
            <img
              class="w-[128px] h-[128px] absolute bottom-[-60px] right-[-60px]"
